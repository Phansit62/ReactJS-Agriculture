...
export default function MainNews() {
  ...
  async function fetchData(pagesize = 10, currentpage = 1, search) {
    const res = await getNews(pagesize, currentpage, search);
    if (res) {
        ...
        {({ setFieldValue, values }) => (
          <Form>
            <div className="flex justify-end">
              <button type="button" className="p-2 bg-green-700 text-white rounded-lg my-2" onClick={() => navigate("/news/form")}>
